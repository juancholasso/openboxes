    ...
    def showForecastReport = {
        ...
        if (params.format == "text/csv" && params.print) {
            ...
            data.groupBy { it.productId }.collect { productId, items ->
                ...
                def onOrderData = reportService.getOnOrderData(params.originId, productId)
                def inventoryLevel
                ...
                def qtyOnOrder = onOrderData[0]?.totalOnOrder ?: 0
                def qtyOnHand = onOrderData[0]?.totalOnHand ?: 0
